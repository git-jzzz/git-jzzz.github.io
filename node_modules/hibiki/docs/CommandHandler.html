...
<head>
    <meta charset="utf-8">
    <title>CommandHandler - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">CommandHandler</h1>
...
<article>
    ...
    <h4 class="name" id="CommandHandler"><span class="type-signature"></span>new CommandHandler<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ext_CommandHandler.js.html">ext/CommandHandler.js</a>, <a href="ext_CommandHandler.js.html#line9">line 9</a>
    </li></ul></dd>
...
<h4 class="name" id="buckets"><span class="type-signature"></span>buckets<span class="type-signature"> :Map.&lt;string, <a href="Ratelimiter.html">Ratelimiter</a>></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ext_CommandHandler.js.html">ext/CommandHandler.js</a>, <a href="ext_CommandHandler.js.html#line23">line 23</a>
    </li></ul></dd>
...
<span class="param-type">Map.&lt;string, <a href="Ratelimiter.html">Ratelimiter</a>></span>
    ...
    <h4 class="name" id="checkArguments"><span class="type-signature"></span>checkArguments<span class="signature">(msg, given, args)</span><span class="type-signature"> &rarr; {Promise.&lt;map>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ext_CommandHandler.js.html">ext/CommandHandler.js</a>, <a href="ext_CommandHandler.js.html#line234">line 234</a>
    </li></ul></dd>
    ...
    <dd class="tag-todo">
        <ul>
            <li>add search things</li>
        
            <li>add websockets and try to get the guild/user from another shard</li>
        </ul>
    </dd>
...
<div class="description">
    <p>Check the arguments and return new args</p>
</div>
...
<span class="param-type">Eris.Message</span>
...
<span class="param-type">Array.&lt;string></span>
            ...
            <td class="description last"><p>Array of given arguments</p></td>
        </tr>
...
<span class="param-type">Array.&lt;ICommandArg></span>
            ...
            <td class="description last"><p>Array of command args</p></td>
        </tr>
...
<span class="param-type">Promise.&lt;map></span>
    ...
    <h4 class="name" id="checkBotPermissions"><span class="type-signature"></span>checkBotPermissions<span class="signature">(msg, perms)</span><span class="type-signature"> &rarr; {Promise.&lt;map>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ext_CommandHandler.js.html">ext/CommandHandler.js</a>, <a href="ext_CommandHandler.js.html#line204">line 204</a>
    </li></ul></dd>
...
<span class="param-type">Array.&lt;ICommandPermission></span>
            ...
            <td class="description last"><p>Array of permissions</p></td>
        </tr>
...
<span class="param-type">Promise.&lt;map></span>
    ...
    <h4 class="name" id="checkMessage"><span class="type-signature"></span>checkMessage<span class="signature">(msg)</span><span class="type-signature"> &rarr; {Promise.&lt;void>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ext_CommandHandler.js.html">ext/CommandHandler.js</a>, <a href="ext_CommandHandler.js.html#line41">line 41</a>
    </li></ul></dd>
...
<div class="description">
    <p>Check if a message is a command</p>
</div>
...
<span class="param-type">Promise.&lt;void></span>
    ...
    <h4 class="name" id="checkPermissions"><span class="type-signature"></span>checkPermissions<span class="signature">(msg, perms)</span><span class="type-signature"> &rarr; {Promise.&lt;map>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ext_CommandHandler.js.html">ext/CommandHandler.js</a>, <a href="ext_CommandHandler.js.html#line178">line 178</a>
    </li></ul></dd>
...
<span class="param-type">Promise.&lt;map></span>
    ...
    <h4 class="name" id="executeCommand"><span class="type-signature"></span>executeCommand<span class="signature">(msg, command, args, prefix)</span><span class="type-signature"> &rarr; {Promise.&lt;any>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ext_CommandHandler.js.html">ext/CommandHandler.js</a>, <a href="ext_CommandHandler.js.html#line93">line 93</a>
    </li></ul></dd>
...
<span class="param-type">minimist.ParsedArgs</span>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Prefix used</p></td>
        </tr>
...
<span class="param-type">Promise.&lt;any></span>
    ...
    <h4 class="name" id="init"><span class="type-signature"></span>init<span class="signature">()</span><span class="type-signature"> &rarr; {Promise.&lt;void>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="ext_CommandHandler.js.html">ext/CommandHandler.js</a>, <a href="ext_CommandHandler.js.html#line30">line 30</a>
    </li></ul></dd>
...
<div class="description">
    <p>Initializes the command handler</p>
</div>
