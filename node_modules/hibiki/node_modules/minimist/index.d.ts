...
// Project: https://github.com/noud02/minimist
// Definitions by: Bart van der Schoor <https://github.com/Bartvds>, Necroskillz <https://github.com/Necroskillz>, kamranayub <https://github.com/kamranayub>, Noud Kerver <https://github.com/noud02>
// Definitions: https://github.com/noud02/minimist
 ...
 */
declare function minimist(args?: string[] | string, opts?: minimist.Opts): minimist.ParsedArgs;
 ...
 * @param opts An optional options object to customize the parsing
 */
declare function minimist<T>(args?: string[] | string, opts?: minimist.Opts): T & minimist.ParsedArgs;
...
declare namespace minimist {
    export interface Opts {
        ...
        /**
         * Treat al numbers as strings if set to true
         */
        strings?: boolean;
    }
